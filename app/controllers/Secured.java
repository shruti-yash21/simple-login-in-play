...
public class Secured extends Security.Authenticator {
  ...
  public String getUsername(Context ctx) {
    System.out.println("hey 1 secured getUsername :: " + ctx.session().get("role"));
  ...
  public Result onUnauthorized(Context context) {
    // System.out.println("hey 2 secured onUnauthorized :: " + context);
  ...
  public static String getUser(Context ctx) {
    // System.out.println("hey 3 secured getUsername :: " + ctx);
    return ctx.session().get("email");
  }
  ...
  public static boolean isLoggedIn(Context ctx) {
    // System.out.println("hey 4 secured getUsername :: " + ctx);
  ...
  public static UserInfo getUserInfo(Context ctx) {
    //System.out.println("hey 5 secured getUsername :: " + ctx);
