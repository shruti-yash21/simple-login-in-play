...
public class UserInfoDB {
   ...
   */
  public static void addUserInfo(String name, String email, String password, String role) {
    userinfos.put(email, new UserInfo(name, email, password, role));
  }
  // public static void addUserInfo(String name, obj info) {
  //   userinfos.put(email, info);
  // }
